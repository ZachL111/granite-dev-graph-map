"""Regression checks for the granite-dev-graph-map casebook."""
...
from casebook.harness import assert_expected, granite_dev_graph_map_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_dev_graph_map_summary(), assert_expected())
