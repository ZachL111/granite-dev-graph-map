...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite-dev-graph-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite-dev-graph-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite-dev-graph-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite_dev_graph_map-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
